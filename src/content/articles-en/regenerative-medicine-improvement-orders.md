---
title: "Japan's MHLW Issues Regenerative Medicine Improvement Orders: Five Operational Checks for Clinics"
description: "Five practical checks for clinics after Japan's MHLW published improvement orders involving regenerative medicine providers and cell-processing operations."
...
## Five operational points clinics should review

Based on the matters identified in the MHLW materials, the following five areas deserve particular attention.

### 1. Is the medical institution itself deciding whether and how treatment should be provided?
...
### 2. Is the basis for patient eligibility recorded in the medical record?
...
### 4. Are instructions to and checks on outsourced cell-processing operators effective?
...
### 5. Does the relationship with outside businesses undermine the clinic's medical independence?
...
- Whether the approved treatment plan matches the actual clinical workflow
- Whether patient eligibility decisions and their rationale are documented in the medical record
- Whether the workflow for adverse-event or disease reporting is clear and operational
- Whether instructions to and checks on outsourced cell-processing operators are actually being carried out
- Whether an outside business is effectively deciding patient selection or treatment conditions
- Whether responsible persons and review procedures are understood inside the clinic
...
- Ministry of Health, Labour and Welfare, "Improvement Orders and Other Measures under the Act on the Safety of Regenerative Medicine" (July 31, 2026)

## Related information

- [HDN Japan](https://hdnjapan.com/)
- [Support for introducing self-pay medical services](https://hdnjapan.com/self-pay.html)
- [Contact HDN](https://forms.gle/148jgfSnDgDZ2HsEA)
