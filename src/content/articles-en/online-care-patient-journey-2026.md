---
title: "Why Telemedicine Still Breaks When Only the Consultation Goes Online"
socialTitle: "Telemedicine fails when only the consultation goes online"
description: "Japan's 2026 telemedicine rules make it even more important to design identity checks, patient explanations, booking, payment, and follow-up as one connected journey."
...
## The patient journey starts before the booking button
...
## Identity verification should not be an improvised task at the start of the call
...
## When booking, questionnaires and payment are disconnected, staff become the integration layer
...
## Telemedicine does not end when the video call ends
...
## In 2026, the real operational burden often sits around the consultation screen
...
- [Ministry of Health, Labour and Welfare: Online medical care](https://www.mhlw.go.jp/stf/index_0024_00004.html)
- [MHLW guidance on the appropriate implementation of online medical care](https://www.mhlw.go.jp/web/t_doc?dataId=00tc3339&dataType=1&pageNo=1)
- [MHLW notice on the 2026 Medical Care Act implementation for online care](https://www.mhlw.go.jp/web/t_doc?dataId=00tc9893&dataType=1&pageNo=1)
